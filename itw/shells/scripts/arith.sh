#!/bin/bash
#This script is used to perform arithmetic operations such as addition,subtraction,multipication,division,powerof but be careful it lacks floating point precision.
if [ $# -ne 0 ]
then 
...
in
	...
	4)read -p "Enter Dividend: " x ; read -p "Enter Divisor: " y ; if [ $y -ne 0 ] ;then  echo $(($x/$y)) ;else echo "ZeroDivisionError";fi ;;
